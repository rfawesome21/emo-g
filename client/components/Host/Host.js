...
const Host = () => {
    ...
    return (
        <div className='h-full flex flex-col'>
            ...
            <div className="absolute xs-mobile:bottom-52 sm:bottom-64 lg:bottom-36 left-0 flex justify-center w-100"><Button text = {'Login'} clickHandler = {() => router.push('/host/settings')} /></div>
        </div>
    )
}
