  ...
  if (!deletedRow || deletedRow.length===0){
    ...
    <div style={{width:"500px"}}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 548 548">
            ...
            <path onClick={() => {emotionFunction("acceptance"); setSelectedEmotion("acceptance")}} className={currentRoundEmotion && currentRoundEmotion!=="ACCEPTANCE"?"disabled":selectedEmotion==="acceptance"?"acceptance stroke selected":"acceptance stroke"} d="M438.54,181.31a191.59,191.59,0,0,0-71.82-72.81l19.43-46.9a23.92,23.92,0,0,0,.94-2.74A245.9,245.9,0,0,1,489,160.61a23.2,23.2,0,0,0-2.7.92Z"/>
            <path onClick={() => {emotionFunction("trust"); setSelectedEmotion("trust")}} className={currentRoundEmotion && currentRoundEmotion!=="TRUST"?"disabled":selectedEmotion==="trust"?"trust stroke selected":"trust stroke"} d="M384.61,219.12a124.68,124.68,0,0,0-56-55.87H329a22.46,22.46,0,0,0,20.79-13.89l15.38-37.15a187.74,187.74,0,0,1,69.64,70.63l-36.32,15a22.56,22.56,0,0,0-13.89,21.23Z"/>
            <path onClick={() => {emotionFunction("admiration"); setSelectedEmotion("admiration")}} className={currentRoundEmotion && currentRoundEmotion!=="ADMIRATION"?"disabled":selectedEmotion==="admiration"?"admiration selected stroke":"admiration stroke"} d="M321.89,164.53a120.43,120.43,0,0,1,61.86,62.23L278,270.57Z"/>
            <path onClick={() => {emotionFunction("serenity"); setSelectedEmotion("serenity")}} className={currentRoundEmotion && currentRoundEmotion!=="SERENITY"?"disabled":selectedEmotion==="serenity"?"serenity stroke selected":"serenity stroke"} d="M325.34,90.82A192.24,192.24,0,0,0,221.8,89.63L203.11,44.5a23.29,23.29,0,0,0-1.29-2.6,244.49,244.49,0,0,1,144-.11,21.43,21.43,0,0,0-1.27,2.59Z"/>
            <path onClick={() => {emotionFunction("joy"); setSelectedEmotion("joy")}} className={currentRoundEmotion && currentRoundEmotion!=="JOY"?"disabled":selectedEmotion==="joy"?"joy stroke selected":"joy stroke"} d="M234.28,157.08a22.64,22.64,0,0,0,5.19-24.81L223.35,93.35A188.44,188.44,0,0,1,323.8,94.53l-15.58,37.61A22.57,22.57,0,0,0,313.38,157a123.94,123.94,0,0,0-79.1.12Z"/>
            <path className={currentRoundEmotion && currentRoundEmotion!=="ECSTACY"?"disabled":selectedEmotion==="ecstacy"?"ecstacy stroke selected":"ecstacy stroke"} onClick={() => {emotionFunction("ecstacy"); setSelectedEmotion("ecstacy")}} d="M230.27,162.81a119.79,119.79,0,0,1,87.93.18L274.27,269Z"/>
            <path onClick={() => {emotionFunction("interest"); setSelectedEmotion("interest")}} className={currentRoundEmotion && currentRoundEmotion!=="INTEREST"?"disabled":selectedEmotion==="interest"?"interest stroke selected":"interest stroke"} d="M61.6,161.85a24.6,24.6,0,0,0-2.74-.94A245.9,245.9,0,0,1,160.61,59a23.2,23.2,0,0,0,.92,2.7L180,106.36a191.35,191.35,0,0,0-74.84,73.54Z"/>
            <path onClick={() => {emotionFunction("anticipation"); setSelectedEmotion("anticipation")}} className={currentRoundEmotion && currentRoundEmotion!=="ANTICIPATION"?"disabled":selectedEmotion==="anticipation"?"anticipation stroke selected":"anticipation stroke"} d="M163.25,219.41a22.58,22.58,0,0,0-13.88-21.21L108.9,181.45a187.38,187.38,0,0,1,72.66-71.38l16.33,39.43a22.43,22.43,0,0,0,20.79,13.89h.45A124.6,124.6,0,0,0,163.25,219.41Z"/>
            <path onClick={() => {emotionFunction("vigilance"); setSelectedEmotion("vigilance")}} className={currentRoundEmotion && currentRoundEmotion!=="VIGILANCE"?"disabled":selectedEmotion==="vigilance"?"vigilance stroke selected":"vigilance stroke"} d="M164.34,226.57a120.26,120.26,0,0,1,62.23-62.23l44,106.23Z"/>
            <path onClick={() => {emotionFunction("apprehension"); setSelectedEmotion("apprehension")}} className={currentRoundEmotion && currentRoundEmotion!=="APPREHENSION"?"disabled":selectedEmotion==="apprehension"?"apprehension stroke selected":"apprehension stroke"} d="M506.21,345.84a21.43,21.43,0,0,0-2.59-1.27l-47.76-19.78a192.19,192.19,0,0,0-.22-101.85l47.86-19.83a23.29,23.29,0,0,0,2.6-1.29,244.49,244.49,0,0,1,.11,144Z"/>
            <path onClick={() => {emotionFunction("terror"); setSelectedEmotion("terror")}} className={currentRoundEmotion && currentRoundEmotion!=="TERROR"?"disabled":selectedEmotion==="terror"?"terror stroke selected":"terror stroke"} d="M279.5,274.27l105.77-43.81a119.83,119.83,0,0,1-.18,87.54Z"/>
            <path onClick={() => {emotionFunction("fear"); setSelectedEmotion("fear")}} className={currentRoundEmotion && currentRoundEmotion!=="FEAR"?"disabled":selectedEmotion==="fear"?"fear stroke selected":"fear stroke"} d="M415.86,308.22A22.5,22.5,0,0,0,391,313.38a123.94,123.94,0,0,0-.11-79.07,22.56,22.56,0,0,0,16.2,6.87,22.32,22.32,0,0,0,8.59-1.71l36.2-15a188.35,188.35,0,0,1,.22,98.77Z"/>
            <path onClick={() => {emotionFunction("distraction"); setSelectedEmotion("distraction")}} className={currentRoundEmotion && currentRoundEmotion!=="DISTRACTION"?"disabled":selectedEmotion==="distraction"?"distraction stroke selected":"distraction stroke"} d="M387.39,489a23.2,23.2,0,0,0-.92-2.7L367.2,439.76a191.57,191.57,0,0,0,71.74-73.26l47.46,19.65a23.92,23.92,0,0,0,2.74.94A245.9,245.9,0,0,1,387.39,489Z"/>
            <path onClick={() => {emotionFunction("amazement"); setSelectedEmotion("amazement")}} className={currentRoundEmotion && currentRoundEmotion!=="AMAZEMENT"?"disabled":selectedEmotion==="amazement"?"amazement stroke selected":"amazement stroke"} d="M278,278,383.55,321.7a120.53,120.53,0,0,1-61.85,61.85Z"/>
            <path onClick={() => {emotionFunction("surprise"); setSelectedEmotion("surprise")}} className={currentRoundEmotion && currentRoundEmotion!=="SURPRISE"?"disabled":selectedEmotion==="surprise"?"surprise stroke selected":"surprise stroke"} d="M350.11,398.5a22.43,22.43,0,0,0-20.79-13.89h-.45a124.76,124.76,0,0,0,55.9-56.06,22.61,22.61,0,0,0,13.86,21.24L435.23,365A187.71,187.71,0,0,1,365.66,436Z"/>
            <path onClick={() => {emotionFunction("pensiveness"); setSelectedEmotion("pensiveness")}} className={currentRoundEmotion && currentRoundEmotion!=="PENSIVENESS"?"disabled":selectedEmotion==="pensiveness"?"pensiveness stroke selected":"pensiveness stroke"} d="M274,517a243,243,0,0,1-71.84-10.79,21.43,21.43,0,0,0,1.27-2.59l18.5-44.68a192.34,192.34,0,0,0,103.93-1.36l19,45.92a23.29,23.29,0,0,0,1.29,2.6A243,243,0,0,1,274,517Z"/>
            <path onClick={() => {emotionFunction("grief"); setSelectedEmotion("grief")}} className={currentRoundEmotion && currentRoundEmotion!=="GRIEF"?"disabled":selectedEmotion==="grief"?"grief stroke selected":"grief stroke"} d="M274,393.46a118.59,118.59,0,0,1-43.54-8.19L274.27,279.5,318,385.09A118.75,118.75,0,0,1,274,393.46Z"/>
            <path onClick={() => {emotionFunction("sadness"); setSelectedEmotion("sadness")}} className={currentRoundEmotion && currentRoundEmotion!=="SADNESS"?"disabled":selectedEmotion==="sadness"?"sadness stroke selected":"sadness stroke"} d="M271.46,461.43a187.45,187.45,0,0,1-48-6.21l16.3-39.36a22.58,22.58,0,0,0-5.2-24.83,124.06,124.06,0,0,0,79.11-.09,22.54,22.54,0,0,0-5.16,24.79l15.8,38.13A187.41,187.41,0,0,1,271.46,461.43Z"/>
            <path onClick={() => {emotionFunction("boredom"); setSelectedEmotion("boredom")}} className={currentRoundEmotion && currentRoundEmotion!=="BOREDOM"?"disabled":selectedEmotion==="boredom"?"boredom stroke selected":"boredom stroke"} d="M160.91,489.14A245.9,245.9,0,0,1,59,387.39a23.2,23.2,0,0,0,2.7-.92l43.37-18a191.26,191.26,0,0,0,75,73.74L161.85,486.4A23.92,23.92,0,0,0,160.91,489.14Z"/>
            <path onClick={() => {emotionFunction("loathing"); setSelectedEmotion("loathing")}} className={currentRoundEmotion && currentRoundEmotion!=="LOATHING"?"disabled":selectedEmotion==="loathing"?"loathing stroke selected":"loathing stroke"} d="M226.76,383.75a120.37,120.37,0,0,1-62.22-61.86l106-43.92Z"/>
            ...
            <path onClick={() => {emotionFunction("annoyance"); setSelectedEmotion("annoyance")}} className={currentRoundEmotion && currentRoundEmotion!=="ANNOYANCE"?"disabled":selectedEmotion==="annoyance"?"annoyance stroke selected":"annoyance stroke"} d="M41.9,346.18a244.49,244.49,0,0,1-.11-144,21.43,21.43,0,0,0,2.59,1.27l43.34,17.95a192.17,192.17,0,0,0,0,105.63L44.5,344.89A23.29,23.29,0,0,0,41.9,346.18Z"/>
            <path onClick={() => {emotionFunction("rage"); setSelectedEmotion("rage")}} className={currentRoundEmotion && currentRoundEmotion!=="RAGE"?"disabled":selectedEmotion==="rage"?"rage stroke selected":"rage stroke"} d="M163,318.2a119.79,119.79,0,0,1-.18-87.93l106.23,44Z"/>
            <path onClick={() => {emotionFunction("anger"); setSelectedEmotion("anger")}} className={currentRoundEmotion && currentRoundEmotion!=="ANGER"?"disabled":selectedEmotion==="anger"?"anger stroke selected":"anger stroke"} d="M91.4,325.47a188.19,188.19,0,0,1,0-102.55l40.7,16.86A22.48,22.48,0,0,0,157,234.61a124.06,124.06,0,0,0,.09,79.05,22.52,22.52,0,0,0-24.77-5.13Z"/>
            <path onClick={() => {emotionFunction("optimism"); setSelectedEmotion("optimism")}} className={currentRoundEmotion && currentRoundEmotion!=="OPTIMISM"?"disabled":selectedEmotion==="optimism"?"optimism stroke selected":"optimism stroke"} d="M218.68,159.39A18.43,18.43,0,0,1,201.59,148L165.23,60.19a18.44,18.44,0,0,1,10-24.16,18.29,18.29,0,0,1,7.07-1.42A18.5,18.5,0,0,1,199.41,46l36.36,87.77a18.55,18.55,0,0,1-9.75,24l-.1,0-.09.05A18.5,18.5,0,0,1,218.68,159.39Z"/>
            <path onClick={() => {emotionFunction("aggressiveness"); setSelectedEmotion("aggressiveness")}} className={currentRoundEmotion && currentRoundEmotion!=="AGGRESSIVENESS"?"disabled":selectedEmotion==="aggressiveness"?"aggressiveness stroke selected":"aggressiveness stroke"} d="M140.75,237.5a18.41,18.41,0,0,1-7.08-1.42L45.91,199.73A18.51,18.51,0,0,1,53,164.13a19.64,19.64,0,0,1,2.61.18,18.5,18.5,0,0,1,4.46,1.24l87.77,36.35a18.52,18.52,0,0,1,10,24.12l-.16.34v.06A18.44,18.44,0,0,1,140.75,237.5Z"/>
            <path onClick={() => {emotionFunction("contempt"); setSelectedEmotion("contempt")}} className={currentRoundEmotion && currentRoundEmotion!=="CONTEMPT"?"disabled":selectedEmotion==="contempt"?"contempt stroke selected":"contempt stroke"} d="M53.14,384.19a18.5,18.5,0,0,1-7.1-35.6l87.77-36.36a18.48,18.48,0,0,1,24.13,9.95l.1.22a18.54,18.54,0,0,1-10.08,24L105.2,364.12l-45,18.65A18.53,18.53,0,0,1,55.74,384,18.84,18.84,0,0,1,53.14,384.19Z"/>
