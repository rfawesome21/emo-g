    ...
    <div style={{width:"500px"}}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 548 548">
        <g id="Layer_2" data-name="Layer 2">
          ...
          <path className={currentRoundEmotion && currentRoundEmotion!=="INTEREST"?"disabled":"cls-9"} d="M61.21,162.78a21.53,21.53,0,0,0-3.83-1.2,246.8,246.8,0,0,1,103.89-104,21.71,21.71,0,0,0,1.19,3.8l18.83,45.47a190.29,190.29,0,0,0-75.68,74.36Z"/>
